...
public class IEFExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(IEFDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new IEFStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static IEFDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static IEFDateTimeConverter dateTimeConverter = new IEFStandardDateTimeConverter();

    public IEFExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public IEFExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new IEFMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=IEFHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,IEFExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=IEFHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }

...
public class IEFKPSPublicSoap
{
    ...
    public IEFKPSPublicSoap(){}

    public IEFKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public IEFKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        IEFExtendedSoapSerializationEnvelope envelope= new IEFExtendedSoapSerializationEnvelope(IEFExtendedSoapSerializationEnvelope.VER11);
